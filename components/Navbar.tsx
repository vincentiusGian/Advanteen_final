        ...
        <div className="flex items-center justify-between h-24">
          ...
          <div className="flex items-center space-x-4 md:space-x-6 lg:space-x-8">
            ...
            <nav className="hidden lg:flex items-center space-x-8">
              {navItems.map(item => (
                <a 
                  ...
                  className="text-slate-700 font-semibold hover:text-indigo-500 transition-colors"
                >
                  {item}
                </a>
              ))}
            ...
            <div className="flex items-center space-x-3 md:space-x-5">
              ...
              <button 
                className="flex items-center space-x-2 pl-2 pr-4 py-1.5 bg-indigo-600 text-white rounded-full shadow-lg shadow-indigo-500/30 hover:bg-indigo-700 transition-all transform hover:scale-105"
